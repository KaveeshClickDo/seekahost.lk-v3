            ...
            <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2 mb-8 md:mb-0">
                    ...
                    <ul className="space-y-2 mb-8">
                        <li className="flex items-start text-md md:text-lg text-gray-700 font-medium">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                        <button className="bg-blue-600 text-white text-base sm:text-lg font-medium w-full sm:w-auto border border-blue-600 px-4 sm:px-5 md:px-6 py-3 md:py-4 rounded-full hover:bg-white hover:text-blue-600 transition-colors duration-300">
                            Get Started
                        </button>
                        <Link
                            href="#"
