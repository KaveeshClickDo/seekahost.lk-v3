    ...
    return (
        <section className="relative w-full py-12">
            ...
            <div className="relative z-1 max-w-7xl mx-auto px-7 text-center md:mt-10">
                ...
                <Link href="/woocommerce-hosting-features" className="bg-white text-[#0066CC] md:text-lg border border-[#0066CC] px-6 py-2 rounded-full hover:bg-[#0066CC] hover:text-white transition-colors cursor-pointer font-medium">
                    Compare Packages
                </Link>
            </div>
        </section>
