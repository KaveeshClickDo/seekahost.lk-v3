...
export default function OrderNow1() {
    const t = useTranslations('CheapHostingPage.OrderNow1');
    return (
        <>
            <section className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto py-12 px-4 md:px-0 md:my-10">
                ...
                <div className="md:w-1/2 mt-6 md:mt-0 px-5">
                    ...
                    <SeePlansButton
                        text={t('buttonName')}
                        baseClasses={true}
                        className="bg-[#0066CC] hover:bg-[#0A488A] text-white border border-[#0066CC] px-6 py-2 rounded-full transition-colors font-bold mt-7 md:mt-8"
                    />
