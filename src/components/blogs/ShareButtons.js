  ...
  return (
    <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200">
      ...
      <div className="block sm:hidden">
        <div className="text-sm text-gray-500 mb-4 text-center">Share this article</div>
        <div className="grid grid-cols-5 gap-3 justify-items-center">
          {/* Copy link button */}
          <button
            onClick={handleCopyLink}
            className="w-10 h-10 bg-[#2072CC] hover:bg-[#0B4A8E] text-white rounded-full flex items-center justify-center transition-colors cursor-pointer relative active:scale-95"
            title="Copy link"
          >
            ...
            {showCopySuccess && (
              <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-black text-white text-xs px-3 py-2 rounded-lg whitespace-nowrap z-10">
                Link copied!
          ...
          <button
            ...
            className="w-10 h-10 bg-black hover:bg-gray-700 text-white rounded-full flex items-center justify-center transition-colors cursor-pointer active:scale-95"
            title="Share on X"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="w-10 h-10 bg-blue-600 hover:bg-blue-700 text-white rounded-full flex items-center justify-center transition-colors cursor-pointer active:scale-95"
          ...
          <button
            ...
            className="w-10 h-10 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center transition-colors cursor-pointer active:scale-95"
