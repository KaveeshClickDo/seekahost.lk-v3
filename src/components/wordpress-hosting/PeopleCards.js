    ...
    const people = [
        {
            ...
            comment: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna Lorem ipsum dolor sit amet"
        }
    ];
            ...
            <section className="relative min-h-[600px]">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto py-12 px-4 md:px-0 h-full">
                    ...
                    <div className="md:w-2/3 mt-6 md:mt-0 px-5">
                        ...
                        <p className="mb-2 text-lg md:text-xl text-white font-semibold">{people[0].name}</p>
                        <p className="text-white">{people[0].company}</p>
                    </div>
                </div>
            </section>
        </>
