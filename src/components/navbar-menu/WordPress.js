...
export default function WordPress() {
    return (
        <div className="absolute -left-136.5 w-3xl xl:w-5xl rounded-xl bg-white shadow-lg z-20">
            <div className="container mx-auto flex flex-wrap">
                ...
                <div className="w-full lg:w-1/3 rounded-xl bg-gray-50 p-6 flex flex-col justify-center">
                    <h3 className="font-bold text-blue-600 text-lg mb-2">WordPress Platforms</h3>
